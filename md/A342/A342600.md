...
https://oeis.org/A342600
## JSON
```JSON
[0, 1, 3, 7, 17, 39, 91, 211, 487, 1123, 2589, 5963, 13725, 31583, 72661, 167131, 384377, 883951, 2032723, 4674299, 10748631, 24716955, 56839003, 130710843, 300603331, 691345931, 1590077703, 3657329539, 8412668791, 19352107787, 44519281727, 102422137915]
```
## Mathematica
```Mathematica
...
## PARI
```PARI
A342600(n) = A342859(n,n); \\ (Also uses code from A342859.) - _Antti Karttunen_, Mar 28 2021
```
## Python
```Python
