...
## Mathematica
```Mathematica
zOF[n_Integer?Positive]:=Module[{maxpow=0},While[5^maxpow<=n,maxpow++];Plus@@Table[ Quotient[n,5^i],{i,maxpow-1}]]; Attributes[zOF]={Listable}; zOF[Range[1000]]//Union (* _Harvey P. Dale_, Dec 06 2023 *)
```
## Haskell
```Haskell
a191610 1 = 0
