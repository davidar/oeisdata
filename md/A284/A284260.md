...
## Mathematica
```Mathematica
Table[Last[Function[s, Select[s, # < First[s]^2 &]]@ FactorInteger[n][[All, 1]] /. {} -> {1}], {n, 109}] (* _Michael De Vlieger_, Mar 24 2017 *)
```
## Scheme
```Scheme
...
for(n=1, 150, print1(gpf(n/a(n)),", ")) \\ _Indranil Ghosh_, Mar 24 2017, after _David A. Corneth_
```
## Python
```Python
