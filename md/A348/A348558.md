...
## Magma
```Magma
f1:=func<n|forall{i:i in [1..#Intseq(n) by 2]| Intseq(n)[i] eq 1}>;  fc:=func<n|forall{i:i in [2..#Intseq(n) by 2]| Intseq(n)[i] ne 1}>; [p:p in PrimesUpTo(17000)|f1(p) and fc(p)]; // _Marius A. Burtea_, Oct 22 2021
```
