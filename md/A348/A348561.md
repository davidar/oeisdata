...
## Magma
```Magma
f9:=func<n|forall{i:i in [1..#Intseq(n) by 2]| Intseq(n)[i] eq 9}>;  fc:=func<n|  forall{i:i in [2..#Intseq(n) by 2]| Intseq(n)[i] ne 9}>; [p:p in PrimesUpTo(100000)|f9(p) and fc(p)]; // _Marius A. Burtea_, Oct 22 2021
```
## Python
```Python
