# The arithmetic function v\_1\(n,5\)\.
https://oeis.org/A289439
## JSON
```JSON
...
## Mathematica
```Mathematica
a[n_]:=n*Max[Table[(Floor[(d - 2)/5] + 1)/d, {d, Divisors[n]}]]; Table[a[n], {n, 2, 100}] (* _Indranil Ghosh_, Jul 08 2017 *)
```
## PARI
```PARI
v(g,n,h)={my(t=0);fordiv(n,d,t=max(t,((d-1-gcd(d,g))\h + 1)*(n/d)));t}
a(n)=v(1,n,5); \\ _Andrew Howroyd_, Jul 07 2017
```
## Python
```Python
