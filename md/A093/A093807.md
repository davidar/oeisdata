...
https://oeis.org/A093807
## JSON
```JSON
[212, 232, 272, 292, 313, 353, 373, 515, 535, 575, 595, 737, 757, 797, 12121, 12521, 12721, 13331, 13531, 13931, 15151, 15551, 15751, 17171, 17371, 17771, 20102, 20302, 20702, 20902, 21112, 21512, 21712, 22322, 22522, 23332, 23732, 24142]
```
## Maple
```Maple
...
## Mathematica
```Mathematica
Cases[If[PalindromeQ@#,{#, {Count[IntegerDigits@#, _?PrimeQ], DigitSum@#}}, Nothing] & /@ Range@60000, {a_, {_?PrimeQ ..}} :>a] (* _Hans Rudolf Widmer_, Jul 26 2024 *)
```
## Python
```Python
